...
if (prevBorderEnd > -1) {
    let batchHtml = `\n            <!-- 배치 2: 14.8x10.4 캡슐형 테두리 -->\n`;
    batchHtml += `            <button class="mf-hotspot pill temp-drag" style="left: 30%; top: 40%; width: 14.8%; height: 10.4%; border-radius: 999px;"></button>\n`;
    batchHtml += `            <div class="mf-callout-custom center temp-drag" style="left: 30%; top: 40%; min-width: 250px;"><span class="title">툴 리턴</span><span class="desc">: 툴을 반환합니다</span></div>\n\n            `;
...
`;
    ...
    console.log('Injected pill border and reset dev tools.');
}
