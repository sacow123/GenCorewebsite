...
c = c.replace(/<div class="mf-rounded-rect" style="left:88.2%; top:94.575%; width:6.5%; height:9.35%;"><\/div>[\s\S]*?<div class="mf-rounded-rect" style="left:95.0%; top:94.375%; width:5.5%; height:8.35%;"><\/div>/, mainPopups);

fs.writeFileSync('index.html', c);
console.log('Fixed popups natively');
