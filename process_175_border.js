...
const rawData = [
  {"index":0,"class":"mf-hotspot","style":"left: 29.5%; top: 39.3%; width: 175px; height: 175px; border-radius: 50%; cursor: move; pointer-events: auto; right: auto;"},
...
const markerStart = c.indexOf('<!-- 배치 2: 임시 테두리 (175px) -->');
if (markerStart > -1) {
...
if (devToolsStart > -1 && devToolsEnd > -1) {
    ...
    console.log('Processed border coordinates and prepared callout dragging.');
} else {
