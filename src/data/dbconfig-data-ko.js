...
만약 계산중에 '경계 옵셋이나 경계각이 너무 적음'과 같은 에러가 발생한다면
해당 수치들을 조금 늘려 다시 시도해보세요.

Overall finishing occlusal side (bridge)_[M1.0B_L15]

교합면을 1.0mm 공구를 사용해 전체적으로 정삭합니다.

계산: 해당 과정의 진행 여부를 선택하실 수 있습니다. (기본 설정값: 예)
...
Fissure machining [Z0.3BX03]

교합면의 그루브를 0.3mm 공구를 사용해 가공합니다.

계산 : 해당 과정을 진행 여부를 선택하실 수 있습니다. (기본 설정값: 아니요)

사용자 정의 영역

Category 1 : T32-Z1.0B

Category 2 : T32-Z1.0B

Category 3 : T32-Z1.0B→T33-Z0.6B

Category 4 : T32-Z1.0B→T33-Z0.6B
...
T33
Z0.6B
선택 사항 (Fissure machining [Z0.6BX05] 사용, 혹은 UDA CAT 3 or 4 사용 시)
`,
  "Wax_Flexible denture": `
템플릿을 사용하기 위한 조건

보철물 유형: Flexible denture
...
Category 5 : T32-Z1.0B→T33-Z0.6B→T34Z0.3B

Category 6 : T32-Z1.0B→T33-Z0.6B→T34Z0.3B
...
T34
Z0.3B
선택 사항 (Fissure machining [Z0.3BX03] 사용, 혹은 UDA CAT 5사용 시)
`
};
